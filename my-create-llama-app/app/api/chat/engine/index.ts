...
const contextSystemPrompt = ({ context = "" }) => {
  ...
  user가 llm프로젝트에 대해 물어본다면 LLM 프로젝트만 대답하십시오. 문서 내 "LLM 분야에 어떠한 지식과 경험이 있는지"는 회사에서 진행 한 프로젝트에 대한 설명이 아니라 권구민의 경험과 지식입니다. 

  전문 문서 번역 영문화, RAG Chat Bot 프로젝트는 LLM프로젝트이자 권구민이 진행 한 Generative AI 프로젝트 입니다. 
